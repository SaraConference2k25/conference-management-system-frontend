  ...
  return (
    <DashboardShell roleLabel="Evaluator" navItems={evaluatorNav} user={authUser} onLogout={handleLogout}>
      ...
      <div className="mb-8">
        ...
        <h2 className="text-2xl font-semibold tracking-[-0.03em] text-[#10213f] mb-1">Paper evaluation</h2>
      ...
      <div className="mb-6 flex flex-col gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:flex-row">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="app-input px-3.5 py-2.5 pl-9 placeholder:text-slate-400"
          />
        </div>
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="app-input w-full px-3.5 py-2.5 sm:w-44"
          >
      ...
      {!papersLoading && !papersError && papers.length > 0 && (
        <div className="space-y-4">
          {filteredPapers.map(paper => {
            ...
            return (
              <div key={paperId} className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm transition-shadow hover:shadow-md">
                {/* Card Header */}
                <div
                  className="cursor-pointer p-5 transition-colors hover:bg-blue-50/30"
                    ...
                    <div className="rounded-xl border border-blue-100 bg-blue-50/60 p-5">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="app-input h-32 resize-none px-3.5 py-2.5 placeholder:text-slate-400"
                        />
                      </div>
                      ...
                      <div className="mt-4 grid grid-cols-1 gap-2 sm:flex sm:flex-wrap sm:items-center">
                        <button
                          ...
                          className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#123c83] px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[#0e3270] disabled:cursor-not-allowed disabled:opacity-60"
                        >
                          {savingId === paperId ? (
                            <>
                        ...
                        <button
                          ...
                          className="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition-colors hover:border-blue-200 hover:bg-blue-50"
                        >
